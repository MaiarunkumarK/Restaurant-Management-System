...
SECRET_KEY = os.environ.get('SECRET_KEY', 'hz8(ou+a7kq72y2@$*w1uhmo)dy_g++9lul1p*+mw%=jgw5(5f')
...
EMAIL_PORT = 587
EMAIL_USE_TLS = True
EMAIL_HOST_USER = 'kesavan5767@gmail.com'   # enter you email address
EMAIL_HOST_PASSWORD = 'ftrs fqko vzpm qlyl'     # enter your password
